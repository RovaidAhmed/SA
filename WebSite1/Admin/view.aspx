...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" 
    ...
    BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="Vertical" Height="155px" Width="992px" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="post_id" OnRowDeleted="Page_Load" OnRowEditing="Page_Load">
