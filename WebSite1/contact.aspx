                        ...
                        <div class="col-12 col-lg-12" id="discriptiondiv">
                            <div class="single-blog-post featured-post">
                                <a href="#" class="post-title">
                                       <div style="margin-left:25%"><h1> رابطہ کی تفصیلات:</h1></div>
                                ...
                                <div class="post-data">
                                 <%-- <a href="politics.aspx" class="post-catagory" style="margin-left:85%;">سیاست سے</a>--%>
                                    ...
                                    <div class="post-meta">
                                        <p style="margin-left:25%; direction:ltr"> <i class="fas fa-envelope"></i> Sareaamofficial@gmail.com </p>
                                                                      
                                         <p style="margin-left:25%;  direction:ltr"> <i class="fas fa-phone"></i> +92- 2137180802 </p>
