<%@ Page Language="C#" AutoEventWireup="true" CodeFile="health.aspx.cs" Inherits="health" %>
                        ...
                        <div class="col-12 col-lg-12" id="discriptiondiv">
                            <div class="single-blog-post featured-post">
                                ...
                                <div class="post-thumb">
                                    <a href="Health.aspx"><img src="./files/<%# Eval("file_name") %>" alt=""></a>
                                </div>
                                <div class="post-data">
                       ...
                       <ItemTemplate> 
                        ...
                        <div class="col-12 col-md-6" >
                            <div class="single-blog-post style-3">
                                <div class="post-thumb">
                                    <a href="Health.aspx?id=<%# Eval("post_id") %>"><img src="./files/<%# Eval("file_name") %>" alt=""></a>
                                </div>
                                <div class="post-data">
                                    <a href="#" class="post-title">
                                        <h6><%# Eval("title") %></h6>
