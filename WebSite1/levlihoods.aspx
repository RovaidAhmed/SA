<%@ Page Language="C#" AutoEventWireup="true" CodeFile="levlihoods.aspx.cs" Inherits="levlihoods" %>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="single-blog-post small-featured-post d-flex">
                        ...
                        <div class="post-data">
                            <a href="world.aspx" class="post-catagory">.</a>
                            <div class="post-meta">
                                <a href="#" class="post-title">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-8">                   
                    ...
                    <asp:Repeater ID="Repeaterlevlihods" runat="server">
                       <ItemTemplate> 

                        <div class="col-12 col-md-6" >
                            <div class="single-blog-post style-3">
                                <div class="post-thumb">
                                    <a href="levlihoods.aspx?id=<%# Eval("post_id") %>"><img src="./files/<%# Eval("file_name") %>" alt=""></a>
                                </div>
                                <div class="post-data">
                                    <a href="#" class="post-title">
                                        <h6><%# Eval("title") %></h6>
